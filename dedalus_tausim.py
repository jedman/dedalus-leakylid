...
stop_time = 4.*3600. # simulation stop time  (seconds)
...
B['g'] = 0.1*np.sin(m * np.pi*z/Lz)*np.cos(k* np.pi* x /Lx) 
B['g'][:,strat] = 0.
...
#dims_d = dp.read_dims_dealiased(data) # read 'dealiased' dimensions
data.close() 
